...
{
  int a = 5;
  // Use single quotes when assigning a char value as double quotes indicate a String.
  ...
  // We need to immediately assign a value to a variable with the const type.
  const char b = 'B';
